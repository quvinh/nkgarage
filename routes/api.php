...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/dashboard/importCode/{month}/{year}', [DashBoardController::class, 'importCode']);
    Route::get('/dashboard/exportCode/{month}/{year}', [DashBoardController::class, 'exportCode']);
